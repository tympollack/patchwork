...
const IGNORED_DIRS = new Set(['node_modules', '.expo', 'coverage', 'dist', 'android', 'ios']);
...
function checkFiles() {
  ...
  // Also include root App.tsx if it exists
  const appFile = path.join(ROOT_DIR, 'App.tsx');
  ...
  console.log('\n📊 Checking Patchwork codebase file sizes (TASK-DEBT-ESLINT-FILESIZE-GUARD)...');
